...
export namespace commands {
    ...
    export type console_error = _et.Command_Procedure<
    ...
    export type console_log = _et.Command_Procedure<
    ...
    export type write_to_directory = _et.Command_Procedure<
    ...
    export type write_to_file = _et.Command_Procedure<
