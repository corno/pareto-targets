...
export const Graph_Attributes: t_signatures.Graph_Attributes = ($,) => ['list', $.__l_map(($,) => ['state', _p.decide.state($, ($,): t_out.Value.state => {
    switch ($[0]) {
        case 'concentrate':
            return _p.ss($, ($,) => ({
                'option': 'concentrate',
...
export const Node_Attributes: t_signatures.Node_Attributes = ($,) => ['list', $.__l_map(($,) => ['state', _p.decide.state($, ($,): t_out.Value.state => {
    switch ($[0]) {
        case 'color':
            return _p.ss($, ($,) => ({
                'option': 'color',
...
export const End_Point_Specification: t_signatures.End_Point_Specification = ($,) => ['group', ['verbose', _p.dictionary.literal(({
    ...
    'port data': _p.deprecated_cc($['port data'], ($,) => ['optional', $.__decide(($,): t_out.Value.optional => ['set', ['group', ['verbose', _p.dictionary.literal(({
        'port': _p.deprecated_cc($['port'], ($,) => ['text', ({
            'delimiter': ['quote', null],
            'value': $,
        })]),
        'compass direction': _p.deprecated_cc($['compass direction'], ($,) => ['optional', $.__decide(($,): t_out.Value.optional => ['set', ['text', ({
            'delimiter': ['quote', null],
            'value': $,
        })]], () => ['not set', null])]),
    }))]]], () => ['not set', null])]),
}))]]
export const Edge_Attributes: t_signatures.Edge_Attributes = ($,) => ['list', $.__l_map(($,) => ['state', _p.decide.state($, ($,): t_out.Value.state => {
    switch ($[0]) {
        case 'arrowhead':
            return _p.ss($, ($,) => ({
                'option': 'arrowhead',
...
export const Graph: t_signatures.Graph = ($,) => ['group', ['verbose', _p.dictionary.literal(({
    'name': _p.deprecated_cc($['name'], ($,) => ['optional', $.__decide(($,): t_out.Value.optional => ['set', ['text', ({
        'delimiter': ['quote', null],
        'value': $,
    })]], () => ['not set', null])]),
    'tree': _p.deprecated_cc($['tree'], ($,) => Tree($)),
...
export const Attribute_Value: t_signatures.Attribute_Value = ($,) => ['state', _p.decide.state($, ($,): t_out.Value.state => {
    switch ($[0]) {
        case 'number':
            return _p.ss($, ($,) => ({
                'option': 'number',
