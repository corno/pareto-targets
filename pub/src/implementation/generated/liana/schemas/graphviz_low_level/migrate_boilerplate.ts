...
export const ID: t_signatures.ID = ($) => _p.deprecated_cc($, ($): t_out.ID => {
    switch ($[0]) {
        case 'id': return _p.ss($, ($) => ['id', $])
        case 'string': return _p.ss($, ($) => ['string', $])
        case 'html': return _p.ss($, ($) => ['html', $])
...
export const Statement_List: t_signatures.Statement_List = ($) => $.__l_map(($) => _p.deprecated_cc($, ($): t_out.Statement_List.L => {
    switch ($[0]) {
        ...
        case 'edge': return _p.ss($, ($) => ['edge', ({
            'left': _p.deprecated_cc($['left'], ($) => _p.deprecated_cc($, ($): t_out.Statement_List.L.edge.left => {
                switch ($[0]) {
                    case 'node': return _p.ss($, ($) => ['node', Node_ID(
                        $
                    )])
                    case 'subgraph': return _p.ss($, ($) => ['subgraph', Subgraph(
                        $
                    )])
                    default: return _p.au($[0])
                }
            })),
            'right': _p.deprecated_cc($['right'], ($) => $.__l_map(($) => _p.deprecated_cc($, ($): t_out.Statement_List.L.edge.right.L => {
                switch ($[0]) {
                    case 'node': return _p.ss($, ($) => ['node', Node_ID(
                        $
                    )])
        ...
        case 'attribute list': return _p.ss($, ($) => ['attribute list', ({
            'type': _p.deprecated_cc($['type'], ($) => _p.deprecated_cc($, ($): t_out.Statement_List.L.attribute_list.type_ => {
                switch ($[0]) {
                    case 'graph': return _p.ss($, ($) => ['graph', null])
                    case 'node': return _p.ss($, ($) => ['node', null])
                    case 'edge': return _p.ss($, ($) => ['edge', null])
                    default: return _p.au($[0])
                }
            })),
            'attributes': _p.deprecated_cc($['attributes'], ($) => Attribute_List(
        ...
        case 'attribute assignment': return _p.ss($, ($) => ['attribute assignment', ({
            'name': _p.deprecated_cc($['name'], ($) => ID(
                $
            )),
            'value': _p.deprecated_cc($['value'], ($) => ID(
...
export const Graph: t_signatures.Graph = ($) => ({
    ...
    'type': _p.deprecated_cc($['type'], ($) => _p.deprecated_cc($, ($): t_out.Graph.type_ => {
        switch ($[0]) {
            case 'graph': return _p.ss($, ($) => ['graph', null])
            case 'digraph': return _p.ss($, ($) => ['digraph', null])
            default: return _p.au($[0])
        }
    })),
